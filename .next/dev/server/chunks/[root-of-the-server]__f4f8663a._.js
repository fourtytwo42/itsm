...
"[project]/lib/services/ticket-service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createTicket(input) {
    ...
    const ticket = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticket.create({
        data: {
            ticketNumber,
            ...
            priority: input.priority ?? __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["TicketPriority"].MEDIUM,
            status: __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["TicketStatus"].NEW
        },
        include: {
            requester: {
                select: {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$websocket$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["wsServer"].broadcastToAll('ticket:created', {
        ticket: {
            id: ticket.id,
    ...
    if (ticket.assigneeId) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$notification$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyTicketCreated"])(ticket.id, ticket.ticketNumber, ticket.assigneeId);
    }
    return ticket;
}
async function listTickets(params) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticket.findMany({
        where: {
...
async function getTicketById(id) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticket.findUnique({
        where: {
            id
        },
        include: {
...
async function updateTicket(id, input) {
    ...
    const currentTicket = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticket.findUnique({
        where: {
            id
        },
        include: {
    ...
    const ticket = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticket.update({
        where: {
            id
        },
        data: {
            ...
            closedAt: input.status === __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["TicketStatus"].CLOSED ? new Date() : undefined
        },
        include: {
            requester: {
                select: {
    ...
    if (input.assigneeId !== undefined && input.assigneeId !== currentTicket.assigneeId) {
        changes.assigneeId = {
            from: currentTicket.assigneeId,
            to: input.assigneeId
        };
    }
    // Broadcast WebSocket event
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$websocket$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["wsServer"].broadcastToTicketSubscribers(id, 'ticket:updated', {
        ticket: {
            id: ticket.id,
            ticketNumber: ticket.ticketNumber,
            subject: ticket.subject,
    ...
    if (Object.keys(changes).length > 0 && userIds.length > 0) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$notification$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyTicketUpdated"])(ticket.id, ticket.ticketNumber, changes, userIds);
    }
    // Handle assignment change
    if (input.assigneeId !== undefined && input.assigneeId !== currentTicket.assigneeId) {
        if (input.assigneeId) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$notification$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyTicketAssigned"])(ticket.id, ticket.ticketNumber, input.assigneeId);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$websocket$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["wsServer"].broadcastToUser(input.assigneeId, 'ticket:assigned', {
                ticket: {
                    id: ticket.id,
                    ticketNumber: ticket.ticketNumber,
                    subject: ticket.subject
...
async function addTicketComment(input) {
    // Get ticket to find all relevant users
    const ticket = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticket.findUnique({
        where: {
            id: input.ticketId
        },
        include: {
    ...
    const comment = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ticketComment.create({
        data: {
    ...
    // Broadcast WebSocket event
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$websocket$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["wsServer"].broadcastToTicketSubscribers(input.ticketId, 'ticket:comment', {
        ticketId: input.ticketId,
        comment: {
            id: comment.id,
            body: comment.body,
    ...
    if (userIds.length > 0) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$notification$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyTicketComment"])(input.ticketId, ticket.ticketNumber, input.authorId, userIds);
    }
    return comment;
}
}),
...
"[project]/app/api/v1/tickets/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$ticket$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/ticket-service.ts [app-route] (ecmascript)");
...
;
;
const createTicketSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
    subject: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(3),
    description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(3),
    priority: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].nativeEnum(__TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["TicketPriority"]).optional(),
    assigneeId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().uuid().optional()
});
const listSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
    status: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].nativeEnum(__TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["TicketStatus"]).optional(),
    priority: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].nativeEnum(__TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["TicketPriority"]).optional(),
    assigneeId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().uuid().optional(),
    requesterId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().uuid().optional()
});
async function GET(request) {
    try {
        ...
        const tickets = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$ticket$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listTickets"])(parsed.data);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: tickets
        });
...
async function POST(request) {
    try {
        const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthContext"])(request);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(auth);
        const body = await request.json();
        const validated = createTicketSchema.parse(body);
        const ticket = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$ticket$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTicket"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f4f8663a._.js.map